...
public class InputView {
	//our dictionary object to store words and translations
	...
	public Parent getView() {
		...
		//adding competitions to the grid pane
		...
		//gets text from tex fields and adds them to dictionary objects which adds them to a list and hashmap
